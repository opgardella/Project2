...
def find_urls(s):
    #find every website and return it (\w+ is non whitespace)
...
def grab_headlines():
    ...
    #url = 'file:///C:/Users/opgar/Documents/SI206/Project2/opinion.html' #run to check if working right
    ...
    for url in urls:
        ...
        for tag in tags:
            ...
            for i in range(len(names)):
                umsi_titles[names[i]] = fields[i].replace('&amp;', "&")
